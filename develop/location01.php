...
<main>
  ...
  <section class="accessline sections clearfix">
    <div class="inner">
      ...
      <ul class="list01">
        <li>
          <p class="lead">羽田空港から既存の鉄道ネットワークを活用して、「東京」駅、「上野」駅などをダイレクトに結ぶ計画。羽田空港の国内線第1ターミナルと第2ターミナルの間に「羽田空港新駅（仮称）」を建設。計画ルートのうち、東京貨物ターミナルまでの約5.0kmの区間に設ける「羽田空港アクセス線（仮称）」は、2023年3月24日付で、国土交通省より工事施工認可を取得、そこから「田町」駅付近へ向かう「東山手ルート」は、2023年1月31日付で、国土交通省より鉄道施設変更認可を取得し、2031年度の運行開始を目指しています。</p>
