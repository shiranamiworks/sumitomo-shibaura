...
<main>
  ...
  <div class="breadcrumb sp-hide">
    <ul>
      ...
      <li><p>「古川橋」駅前が生まれ変わる</p></li>
    </ul>
  </div>
	<!--// パンくずリスト -->

  <div class="location-link location-link--2">
    <a href="location01.html" class="current"><p>「古川橋」駅前が生まれ変わる</p></a>
    <a href="location02.html"><p>たしかな暮らしやすさがここにある</p></a>
  </div>

  <header class="main-visual clearfix">
    <!-- <h2 class="page-lead gothic">Hello New World.</h2> -->
   <div class="image"><img src="./images/location01/mv.png" alt="" class="pc"><img src="./images/location01/mv-sp.png" alt="" class="tb"><p class="annotation">門真市立総合体育館周辺（約510m／徒歩7分）</p></div>
  </header><!-- main-visual -->
  ...
  <section class="intro sections clearfix">
    <div class="inner">
      ...
      <p class="mini">1.三井ショッピングパーク ららぽーと門真・三井アウトレットパーク 大阪門真（約1,470m／徒歩19分）　2.門真市立総合体育館周辺（約510m／徒歩7分）　3.門真市立総合体育館（約400m／徒歩5分）</p>
  </section><!-- intro -->
      ...
      <div class="box">
        ...
        <ul class="column03">
          ...
          <li>
            ...
            <p class="caps">門真市立総合体育館周辺（約510m／徒歩7分）<br>　</p>
    ...
    <div class="design clearfix">
      ...
      <ul class="column02 ring">
        ...
        <li>
          ...
          <div class="image">
            <img src="./images/location01/ring03-01.jpg" alt="">
    ...
    <div class="content">
      ...
      <div class="white-bg">
        ...
        <ul class="column02 list02">
          <li>
            <p class="txt01">建物内外ににぎわいを生み出す<br class="pc">「スパイラルガーデン」</p>
        ...
        <p class="caps">出典：門真市ホームページ（2023年6月現在）</p>
    </div><!-- content -->
    </div><!-- inner -->
  </section>
...
<p class="page-annotation js-scroll wrap clearfix">※掲載の門真市都市計画マスタープラン概念図は一般道路、線路等を抜粋して表記しております。<br>※掲載の航空写真は門真市寿町付近上空から北北西方面を撮影（2023年9月）したものに現地部分の柱などＣＧ合成・加工をしたものです。また、周辺環境は将来変わる場合があります。
※掲載の街区計画概念図は、計画段階の図面を基に描き起こしたものです。<br>※掲載の距離表示については地図上の概測距離を、徒歩分数表示については80mを１分として算出し、端数を切り上げたものです。<br>※掲載の環境写真は2023年8月に撮影。<br>※店舗・施設の内容等は将来変わる場合があります。<br>※掲載の情報は2023年9月現在のものです。<br>※掲載の徒歩分数・距離表示は2023年10月現在のものです。「門真市幸福東土地区画整理事業」(事業主：門真市幸福東土地区画整理組合)に伴う地区外道路4号線および交流広場・交通広場の整備(2026年度完了予定)により、徒歩分数・ルートが変更になる予定です。また、地区外道路4号線および交流広場・交通広場は門真市の所有であり「シティタワー東京田町」の竣工時に完成していない可能性があります。あらかじめご了承ください。</p></div>
</main>
