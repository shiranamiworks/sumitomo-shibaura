<footer class="footer">
  <div class="entry">
    ...
    <script type="text/javascript" src="/bukken_manage/bukken_manage_link.cgi?AREA_CD=shuto&PROP_CD=tamachi"></script>
      <div class="entry-tel">
        <p>お問い合わせは住友不動産<br class="sp">「シティタワー東京田町」</p>
        <a href="<?= $site_setting["tel_link"]?>" class="entry-tel__num"><span class="f-en">0120-167-840</span></a><br>
  ...
  <nav class="footer-menu">
    <div class="container">
      <ul>
        ...
        <li class="design"><a href="<?= $page_settings["directory_pos"]  ?>design01.html">デザイン</a></li>
        <li class="public"><a href="<?= $page_settings["directory_pos"]  ?>public01.html">共用空間</a></li>
  ...
  <div class="footer-wrapper f-min">
    <div class="position-relative">
      ...
      <p class="copyright">Copyright &#169; Sumitomo Realty & Development Co., Ltd.</p>
    </div>
  </div>
