...
<main>
  ...
  <header class="main-visual clearfix">
   ...
   <div class="image"><img src="./images/location02/mv.jpg" alt="" class="pc"><img src="./images/location02/mv-sp.jpg" alt="" class="tb"><p class="annotation white">image photo 高輪ゲートウェイ駅（約2.5km）</p></div>
  </header><!-- main-visual -->
