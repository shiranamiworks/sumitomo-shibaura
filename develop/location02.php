    ...
    <div class="inner">
      ...
      <div class="bg">
        <div class="box">
          ...
          <ul class="column02">
            <li>
              <p class="txt02">徒歩圏に多彩な病院が揃っているので様々な医療サポートを受けることができ、とても安心です。また、歴史ある「愛育病院」は、女性やお子様の診療を専門とした病院で、皇族の方が出産される場所としても有名です。</p>
        ...
        <li>
          <div class="image">
            ...
            <div class="texts pc">
              ...
              <p class="info">天井高約7ｍある空間で楽しむフレンチと江戸前寿司。</p>
            </div>
          </div>
          <div class="texts tb sp">
...
<div class="annotation-area">
  <p class="page-annotation js-scroll wrap clearfix">※1. 都営三田線・浅草線「三田」駅A7出口 徒歩10分。公園ルートの場合（イベント実施時除く）であり、公道ルートの場合はA4出口徒歩11分。<br>※掲載の地図は一部道路・施設等を抜粋しています。<br>※掲載の距離表示については地図上の概測距離を、徒歩分数表示については80mを１分として算出し、端数を切り上げたものです。<br>※掲載の環境写真は2023年9月に撮影。<br>※店舗・施設の内容等は将来変わる場合があります。<br>※掲載の情報は2023年12月現在のものです。</p></div>
</main>
